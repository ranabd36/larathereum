...
namespace Larathereum\Contracts;
...
class SolidityType
{
    ...
    {
        if ($this->isDynamicArray($name)) {
            $arrayOffset = (int)Util::toBn('0x' . mb_substr($value, $offset * 2, 64))->toString();
            $length = (int)Util::toBn('0x' . mb_substr($value, $arrayOffset * 2, 64))->toString();
            ...
            $dynamicOffset = (int)Util::toBn('0x' . mb_substr($value, $offset * 2, 64))->toString();
            $length = (int)Util::toBn('0x' . mb_substr($value, $dynamicOffset * 2, 64))->toString();
