...
use Larathereum\Types\Block;
use Larathereum\Types\BlockHash;
use Larathereum\Types\BlockNumber;
use Larathereum\Types\Transaction;
use Larathereum\Types\TransactionHash;
use Larathereum\Types\TransactionInfo;
use Larathereum\Types\TransactionReceipt;
use Larathereum\Types\Wei;

class EthClient extends AbstractMethods
{
    ...
    public function estimateGas(Transaction $transaction): int
    {
        $response = $this->client->send(
